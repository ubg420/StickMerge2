...
GameGUI.prototype.clickTurbo = function() {
    ...
    this.disableMainButtons();
    if (MainGame.isAPI) {
        if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock) this.buttonActivateTurbo.setEnable(true)
    } else {
...
class Shooter extends Phaser.Scene {
    ...
    showFinishWindow(vBool) {
        ...
        if (vBool) {
            ...
            if (MainGame.isAPI) {
                if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock) this.buttonIncomeX2.setEnable(true)
            } else {
